...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('view-organizational-outcome', function () {
            return Auth::user()->role->hasPermission('manage_organizational_outcome') || Auth::user()->role->name === 'IT' ||  Auth::user()->role->name === 'Admin';
        });

        Gate::define('view-indicator', function () {
            return Auth::user()->role->hasPermission('manage_indicator') || Auth::user()->role->name === 'IT' ||  Auth::user()->role->name === 'Admin';
        });

        Gate::define('view-entries', function () {
            return Auth::user()->role->hasPermission('manage_entries') || Auth::user()->role->name === 'IT' ||  Auth::user()->role->name === 'Admin';
        });
        ...
        Gate::define('manage-user-management', function () {
            return Auth::user()->role->hasPermission('manage_users') || Auth::user()->role->name === 'IT' ||  Auth::user()->role->name === 'Admin';
        });

        Gate::define('manage-roles', function () {
            return Auth::user()->role->hasPermission('manage_roles') || Auth::user()->role->name === 'IT' ||  Auth::user()->role->name === 'Admin';
        });
        ...
        Gate::define('view-history', function () {
            return Auth::user()->role->hasPermission('manage_history') || Auth::user()->role->name === 'IT' ||  Auth::user()->role->name === 'Admin';
        });
